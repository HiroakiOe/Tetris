...
void printMap(void); //積み重なったセルをすべて表示
int checkLine(int y); //一行揃ったか判定
void deleteLine(int ys); //一行マップから揃った一行を削除
int deleteMap(void); //全部マップから揃った行を削除
...
Cell block_type[BLOCK_NUM][BLOCK_SIZE][BLOCK_SIZE] = {
	...
	'\0' ,MAGENDA,BLACK,NORMAL,
	'\0' ,MAGENDA,BLACK,NORMAL,
	'\0' ,MAGENDA,BLACK,NORMAL,
	'\0' ,MAGENDA,BLACK,NORMAL,
	' '  ,MAGENDA,BLACK,REVERSE,
	' '  ,MAGENDA,BLACK,REVERSE,
	' '  ,MAGENDA,BLACK,REVERSE,
	'\0' ,MAGENDA,BLACK,NORMAL,
	'\0' ,MAGENDA,BLACK,NORMAL,
